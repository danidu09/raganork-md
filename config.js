...
module.exports = {
    VERSION: 'v4.0.0',
    ALIVE: process.env.ALIVE || "https://imgur.com/a/yWXF1ID Hey {sender}, I'm alive \n Uptime: {uptime}",
    ...
    STICKER_DATA: process.env.STICKER_DATA || "Danidu Nirmal",
    BOT_NAME: process.env.BOT_NAME || 'Black Adam MD',
